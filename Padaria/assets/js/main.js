...
const blueHeader = () =>{
    ...
    //When the scroll is greater than 50 viewport heigh, add the scrolle blur-header class to the header tag
...
// sr.reveal(`.favorite__card`, { interval: 200 })

sr.reveal(`.footer__card img`, {interval:100, rotate: {z: 15}, distance: 0 })
